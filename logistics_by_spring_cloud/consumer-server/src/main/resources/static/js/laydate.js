...
;!function (a) {
    var b = {
        ...
        h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "skins/", "images/laydate.css"];
    a.laydate = function (b) {
        ...
        var f = d[e]("link");
        f.type = "text/css", f.rel = "stylesheet", f.href = c.getPath + a + h[6], b && (f.id = b), d[g]("head")[0].appendChild(f), f = null
    }, c.trim = function (a) {
