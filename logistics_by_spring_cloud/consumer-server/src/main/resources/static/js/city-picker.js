...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="' +
                    ...
                    '<span id="ctityTextHtml" class="title"></span><div class="arrow"></div>' + '</span>',
        ...
        output: function (type) {
            ...
            //console.info($(".city-select-tab").find(".active").attr("data-count"));
            //console.info($select.attr("data-count"));
            if (code == "86" || code == null) { // 省
