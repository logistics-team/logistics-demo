...
var provinceList = [
    ...
    },
    {
        ...
        cityList: [{
            name: '北京市',
            areaList: ['东城区', '西城区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云县', '延庆县']
        }]
    }, {
        name: '天津',
        cityList: [{
            name: '天津市',
            areaList: ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '滨海新区', '宁河县', '静海县', '蓟县']
        }]
    }, {
        name: '河北省',
        cityList: [{
            ...
            name: '邯郸市',
            areaList: ['邯山区', '丛台区', '复兴区', '峰峰矿区', '邯郸县', '临漳县', '成安县', '大名县', '涉县', '磁县', '肥乡县', '永年县', '邱县', '鸡泽县', '广平县', '馆陶县', '魏县', '曲周县', '武安市']
        }, {
            name: '邢台市',
            areaList: ['桥东区', '桥西区', '邢台县', '临城县', '内丘县', '柏乡县', '隆尧县', '任县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县', '南宫市', '沙河市']
        }, {
            name: '保定市',
            areaList: ['新市区', '北市区', '南市区', '满城县', '清苑县', '涞水县', '阜平县', '徐水县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '安新县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县', '涿州市', '定州市', '安国市', '高碑店市']
        }, {
            name: '张家口市',
            areaList: ['桥东区', '桥西区', '宣化区', '下花园区', '宣化县', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '万全县', '怀来县', '涿鹿县', '赤城县', '崇礼县']
        }, {
            name: '承德市',
        ...
        cityList: [{
            name: '沈阳市',
            areaList: ['和平区', '沈河区', '大东区', '皇姑区', '铁西区', '苏家屯区', '浑南区', '沈北新区', '于洪区', '辽中县', '康平县', '法库县', '新民市']
        }, {
            name: '大连市',
        ...
        }, {name: '金普新区', areaList: ['金州新区', '普湾新区', '保税区']}]
    }, {
        name: '吉林省',
        cityList: [{
            name: '长春市',
        ...
        cityList: [{
            ...
            name: '佳木斯市',
            areaList: ['向阳区', '前进区', '东风区', '郊区', '桦南县', '桦川县', '汤原县', '抚远县', '同江市', '富锦市']
        ...
        }, {name: '大兴安岭地区', areaList: ['加格达奇区', '新林区', '松岭区', '呼中区', '呼玛县', '塔河县', '漠河县']}]
    }, {
        name: '上海',
        cityList: [{
            name: '上海市',
            areaList: ['黄浦区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '奉贤区', '崇明县']
        }]
    }, {
        name: '江苏省',
        cityList: [{
        ...
        cityList: [{
            name: '杭州市',
            areaList: ['上城区', '下城区', '江干区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '桐庐县', '淳安县', '建德市', '富阳区', '临安市']
        }, {
            name: '宁波市',
        ...
        }, {name: '舟山群岛新区', areaList: ['金塘岛', '六横岛', '衢山岛', '舟山本岛西北部', '岱山岛西南部', '泗礁岛', '朱家尖岛', '洋山岛', '长涂岛', '虾峙岛']}]
    }, {
        name: '安徽省',
        cityList: [{
            name: '合肥市',
            areaList: ['瑶海区', '庐阳区', '蜀山区', '包河区', '长丰县', '肥东县', '肥西县', '庐江县', '巢湖市']
        }, {name: '芜湖市', areaList: ['镜湖区', '弋江区', '鸠江区', '三山区', '芜湖县', '繁昌县', '南陵县', '无为县']}, {
            name: '蚌埠市',
            areaList: ['龙子湖区', '蚌山区', '禹会区', '淮上区', '怀远县', '五河县', '固镇县']
        }, {name: '淮南市', areaList: ['大通区', '田家庵区', '谢家集区', '八公山区', '潘集区', '凤台县']}, {
            name: '马鞍山市',
            areaList: ['花山区', '雨山区', '博望区', '当涂县', '含山县', '和县']
        }, {name: '淮北市', areaList: ['杜集区', '相山区', '烈山区', '濉溪县']}, {
            name: '铜陵市',
            areaList: ['铜官山区', '狮子山区', '郊区', '铜陵县']
        }, {
            name: '安庆市',
            areaList: ['迎江区', '大观区', '宜秀区', '怀宁县', '枞阳县', '潜山县', '太湖县', '宿松县', '望江县', '岳西县', '桐城市']
        ...
        }, {name: '龙岩市', areaList: ['新罗区', '长汀县', '永定区', '上杭县', '武平县', '连城县', '漳平市']}, {
            name: '宁德市',
        ...
        cityList: [{
            ...
            name: '九江市',
            areaList: ['庐山区', '浔阳区', '九江县', '武宁县', '修水县', '永修县', '德安县', '星子县', '都昌县', '湖口县', '彭泽县', '瑞昌市', '共青城市']
        }, {name: '新余市', areaList: ['渝水区', '分宜县']}, {name: '鹰潭市', areaList: ['月湖区', '余江县', '贵溪市']}, {
            name: '赣州市',
            areaList: ['章贡区', '南康区', '赣县', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市']
        }, {
            name: '吉安市',
        ...
        cityList: [{
            ...
            name: '青岛市',
            areaList: ['市南区', '市北区', '黄岛区', '崂山区', '李沧区', '城阳区', '胶州市', '即墨市', '平度市', '莱西市', '西海岸新区']
            ...
            name: '滨州市',
            areaList: ['滨城区', '沾化区', '惠民县', '阳信县', '无棣县', '博兴县', '邹平县', '北海新区']
        }, {name: '菏泽市', areaList: ['牡丹区', '曹县', '单县', '成武县', '巨野县', '郓城县', '鄄城县', '定陶县', '东明县']}]
    }, {
        name: '河南省',
        cityList: [{
            name: '郑州市',
            ...
            name: '洛阳市',
            areaList: ['老城区', '西工区', '瀍河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市']
        }, {
            name: '平顶山市',
            ...
            name: '三门峡市',
            areaList: ['湖滨区', '渑池县', '陕县', '卢氏县', '义马市', '灵宝市']
        }, {
            name: '南阳市',
        ...
        cityList: [{
            name: '长沙市',
            areaList: ['芙蓉区', '天心区', '岳麓区', '开福区', '雨花区', '望城区', '长沙县', '宁乡县', '浏阳市']
        ...
        cityList: [{
            ...
            name: '深圳市',
            areaList: ['罗湖区', '福田区', '南山区', '宝安区', '龙岗区', '盐田区', '光明新区', '坪山新区', '大鹏新区', '龙华新区']
            ...
            name: '阳江市',
            areaList: ['江城区', '阳东区', '阳西县', '阳春市']
        }, {name: '清远市', areaList: ['清城区', '清新区', '佛冈县', '阳山县', '连山壮族瑶族自治县', '连南瑶族自治县', '英德市', '连州市']}, {
            name: '东莞市',
            areaList: ['莞城区', '南城区', '万江区', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '大朗镇', '麻涌镇', '中堂镇', '高埗镇', '樟木头镇', '大岭山镇', '望牛墩镇', '黄江镇', '洪梅镇', '清溪镇', '沙田镇', '道滘镇', '塘厦镇', '虎门镇', '厚街镇', '凤岗镇', '长安镇']
        }, {
            name: '中山市',
            areaList: ['石岐区', '南区', '五桂山区', '火炬开发区', '黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '东升镇', '古镇镇', '横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇']
        ...
        cityList: [{
            name: '南宁市',
            areaList: ['兴宁区', '青秀区', '江南区', '西乡塘区', '良庆区', '邕宁区', '武鸣县', '隆安县', '马山县', '上林县', '宾阳县', '横县', '埌东新区']
        }, {
            name: '柳州市',
            areaList: ['城中区', '鱼峰区', '柳南区', '柳北区', '柳江县', '柳城县', '鹿寨县', '融安县', '融水苗族自治县', '三江侗族自治县', '柳东新区']
        }, {
            name: '桂林市',
            areaList: ['秀峰区', '叠彩区', '象山区', '七星区', '雁山区', '临桂区', '阳朔县', '灵川县', '全州县', '兴安县', '永福县', '灌阳县', '龙胜各族自治县', '资源县', '平乐县', '荔浦县', '恭城瑶族自治县']
        ...
        }, {name: '三沙市', areaList: ['西沙群岛', '南沙群岛', '中沙群岛']}, {
            name: '直辖县级',
            areaList: ['五指山市', '琼海市', '儋州市', '文昌市', '万宁市', '东方市', '定安县', '屯昌县', '澄迈县', '临高县', '白沙黎族自治县', '昌江黎族自治县', '乐东黎族自治县', '陵水黎族自治县', '保亭黎族苗族自治县', '琼中黎族苗族自治县']
        }]
    }, {
        name: '重庆',
        cityList: [{
            name: '重庆市',
            areaList: ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南县', '荣昌县', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '开县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县']
        }, {name: '两江新区', areaList: ['北部新区', '保税港区', '工业园区']}]
    }, {
        name: '四川省',
        cityList: [{
            name: '成都市',
            areaList: ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '金堂县', '双流县', '郫县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市']
            ...
            name: '眉山市',
            areaList: ['东坡区', '彭山区', '仁寿县', '洪雅县', '丹棱县', '青神县']
        }, {name: '宜宾市', areaList: ['翠屏区', '南溪区', '宜宾县', '江安县', '长宁县', '高县', '珙县', '筠连县', '兴文县', '屏山县']}, {
            name: '广安市',
            areaList: ['广安区', '前锋区', '岳池县', '武胜县', '邻水县', '华蓥市']
            ...
            name: '阿坝藏族羌族自治州',
            areaList: ['汶川县', '理县', '茂县', '松潘县', '九寨沟县', '金川县', '小金县', '黑水县', '马尔康县', '壤塘县', '阿坝县', '若尔盖县', '红原县']
        }, {
            name: '甘孜藏族自治州',
        ...
        cityList: [{
            name: '昆明市',
            areaList: ['五华区', '盘龙区', '官渡区', '西山区', '东川区', '呈贡区', '晋宁县', '富民县', '宜良县', '石林彝族自治县', '嵩明县', '禄劝彝族苗族自治县', '寻甸回族彝族自治县 ', '安宁市']
        ...
        cityList: [{
            name: '西安市',
            areaList: ['新城区', '碑林区', '莲湖区', '灞桥区', '未央区', '雁塔区', '阎良区', '临潼区', '长安区', '蓝田县', '周至县', '户县', '高陵区']
        }, {name: '铜川市', areaList: ['王益区', '印台区', '耀州区', '宜君县']}, {
            name: '宝鸡市',
            areaList: ['渭滨区', '金台区', '陈仓区', '凤翔县', '岐山县', '扶风县', '眉县', '陇县', '千阳县', '麟游县', '凤县', '太白县']
        }, {
            name: '咸阳市',
            areaList: ['秦都区', '杨陵区', '渭城区', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '彬县', '长武县', '旬邑县', '淳化县', '武功县', '兴平市']
        }, {
            name: '渭南市',
            areaList: ['临渭区', '华县', '潼关县', '大荔县', '合阳县', '澄城县', '蒲城县', '白水县', '富平县', '韩城市', '华阴市']
        }, {
            name: '延安市',
            areaList: ['宝塔区', '延长县', '延川县', '子长县', '安塞县', '志丹县', '吴起县', '甘泉县', '富县', '洛川县', '宜川县', '黄龙县', '黄陵县']
        }, {
            name: '汉中市',
            areaList: ['汉台区', '南郑县', '城固县', '洋县', '西乡县', '勉县', '宁强县', '略阳县', '镇巴县', '留坝县', '佛坪县']
        }, {
            name: '榆林市',
            areaList: ['榆阳区', '神木县', '府谷县', '横山县', '靖边县', '定边县', '绥德县', '米脂县', '佳县', '吴堡县', '清涧县', '子洲县']
        }, {
            name: '安康市',
            areaList: ['汉滨区', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '旬阳县', '白河县']
        }, {name: '商洛市', areaList: ['商州区', '洛南县', '丹凤县', '商南县', '山阳县', '镇安县', '柞水县']}, {
            name: '西咸新区',
            areaList: ['空港新城', '沣东新城', '秦汉新城', '沣西新城', '泾河新城']
        }]
    }, {
        name: '甘肃省',
        cityList: [{name: '兰州市', areaList: ['城关区', '七里河区', '西固区', '安宁区', '红古区', '永登县', '皋兰县', '榆中县']}, {
            name: '嘉峪关市',
        ...
        name: '青海省',
        cityList: [{name: '西宁市', areaList: ['城东区', '城中区', '城西区', '城北区', '大通回族土族自治县', '湟中县', '湟源县']}, {
            name: '海东市',
            areaList: ['乐都区', '平安县', '民和回族土族自治县', '互助土族自治县', '化隆回族自治县', '循化撒拉族自治县']
        ...
        name: '宁夏回族自治区',
        cityList: [{name: '银川市', areaList: ['兴庆区', '西夏区', '金凤区', '永宁县', '贺兰县', '灵武市']}, {
            name: '石嘴山市',
            areaList: ['大武口区', '惠农区', '平罗县']
        }, {name: '吴忠市', areaList: ['利通区', '红寺堡区', '盐池县', '同心县', '青铜峡市']}, {
            name: '固原市',
            areaList: ['原州区', '西吉县', '隆德县', '泾源县', '彭阳县']
        ...
        }, {name: '直辖县级', areaList: ['石河子市', '阿拉尔市', '图木舒克市', '五家渠市', '北屯市', '铁门关市', '双河市']}]
    }, {
        name: '台湾',
        cityList: [{
            name: '台北市',
            areaList: ['松山区', '信义区', '大安区', '中山区', '中正区', '大同区', '万华区', '文山区', '南港区', '内湖区', '士林区', '北投区']
        }, {
            name: '高雄市',
            areaList: ['盐埕区', '鼓山区', '左营区', '楠梓区', '三民区', '新兴区', '前金区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '林园区', '大寮区', '大树区', '大社区', '仁武区', '鸟松区', '冈山区', '桥头区', '燕巢区', '田寮区', '阿莲区', '路竹区', '湖内区', '茄萣区', '永安区', '弥陀区', '梓官区', '旗山区', '美浓区', '六龟区', '甲仙区', '杉林区', '内门区', '茂林区', '桃源区', '那玛夏区']
        }, {name: '基隆市', areaList: ['中正区', '七堵区', '暖暖区', '仁爱区', '中山区', '安乐区', '信义区']}, {
            name: '台中市',
            areaList: ['中区', '东区', '南区', '西区', '北区', '西屯区', '南屯区', '北屯区', '丰原区', '东势区', '大甲区', '清水区', '沙鹿区', '梧栖区', '后里区', '神冈区', '潭子区', '大雅区', '新社区', '石冈区', '外埔区', '大安区', '乌日区', '大肚区', '龙井区', '雾峰区', '太平区', '大里区', '和平区']
        }, {
            name: '台南市',
            areaList: ['东区', '南区', '北区', '安南区', '安平区', '中西区', '新营区', '盐水区', '白河区', '柳营区', '后壁区', '东山区', '麻豆区', '下营区', '六甲区', '官田区', '大内区', '佳里区', '学甲区', '西港区', '七股区', '将军区', '北门区', '新化区', '善化区', '新市区', '安定区', '山上区', '玉井区', '楠西区', '南化区', '左镇区', '仁德区', '归仁区', '关庙区', '龙崎区', '永康区']
        }, {name: '新竹市', areaList: ['东区', '北区', '香山区']}, {name: '嘉义市', areaList: ['东区', '西区']}, {
            name: '新北市',
            areaList: ['板桥区', '三重区', '中和区', '永和区', '新庄区', '新店区', '树林区', '莺歌区', '三峡区', '淡水区', '汐止区', '瑞芳区', '土城区', '芦洲区', '五股区', '泰山区', '林口区', '深坑区', '石碇区', '坪林区', '三芝区', '石门区', '八里区', '平溪区', '双溪区', '贡寮区', '金山区', '万里区', '乌来区']
        }, {
            name: '宜兰县',
            areaList: ['宜兰市', '罗东镇', '苏澳镇', '头城镇', '礁溪乡', '壮围乡', '员山乡', '冬山乡', '五结乡', '三星乡', '大同乡', '南澳乡']
        }, {
            name: '桃园县',
            areaList: ['桃园市', '中坜市', '平镇市', '八德市', '杨梅市', '芦竹市', '大溪镇', '大园乡', '龟山乡', '龙潭乡', '新屋乡', '观音乡', '复兴乡']
        }, {
            name: '新竹县',
            areaList: ['竹北市', '竹东镇', '新埔镇', '关西镇', '湖口乡', '新丰乡', '芎林乡', '横山乡', '北埔乡', '宝山乡', '峨眉乡', '尖石乡', '五峰乡']
        }, {
            name: '苗栗县',
            areaList: ['苗栗市', '苑里镇', '通霄镇', '竹南镇', '头份镇', '后龙镇', '卓兰镇', '大湖乡', '公馆乡', '铜锣乡', '南庄乡', '头屋乡', '三义乡', '西湖乡', '造桥乡', '三湾乡', '狮潭乡', '泰安乡']
        }, {
            name: '彰化县',
            areaList: ['彰化市', '鹿港镇', '和美镇', '线西乡', '伸港乡', '福兴乡', '秀水乡', '花坛乡', '芬园乡', '员林镇', '溪湖镇', '田中镇', '大村乡', '埔盐乡', '埔心乡', '永靖乡', '社头乡', '二水乡', '北斗镇', '二林镇', '田尾乡', '埤头乡', '芳苑乡', '大城乡', '竹塘乡', '溪州乡']
        }, {
            name: '南投县',
            areaList: ['南投市', '埔里镇', '草屯镇', '竹山镇', '集集镇', '名间乡', '鹿谷乡', '中寮乡', '鱼池乡', '国姓乡', '水里乡', '信义乡', '仁爱乡']
        }, {
            name: '云林县',
            areaList: ['斗六市', '斗南镇', '虎尾镇', '西螺镇', '土库镇', '北港镇', '古坑乡', '大埤乡', '莿桐乡', '林内乡', '二仑乡', '仑背乡', '麦寮乡', '东势乡', '褒忠乡', '台西乡', '元长乡', '四湖乡', '口湖乡', '水林乡']
        }, {
            name: '嘉义县',
            areaList: ['太保市', '朴子市', '布袋镇', '大林镇', '民雄乡', '溪口乡', '新港乡', '六脚乡', '东石乡', '义竹乡', '鹿草乡', '水上乡', '中埔乡', '竹崎乡', '梅山乡', '番路乡', '大埔乡', '阿里山乡']
        }, {
            name: '屏东县',
            areaList: ['屏东市', '潮州镇', '东港镇', '恒春镇', '万丹乡', '长治乡', '麟洛乡', '九如乡', '里港乡', '盐埔乡', '高树乡', '万峦乡', '内埔乡', '竹田乡', '新埤乡', '枋寮乡', '新园乡', '崁顶乡', '林边乡', '南州乡', '佳冬乡', '琉球乡', '车城乡', '满州乡', '枋山乡', '三地门乡', '雾台乡', '玛家乡', '泰武乡', '来义乡', '春日乡', '狮子乡', '牡丹乡']
        }, {
            name: '台东县',
            areaList: ['台东市', '成功镇', '关山镇', '卑南乡', '鹿野乡', '池上乡', '东河乡', '长滨乡', '太麻里乡', '大武乡', '绿岛乡', '海端乡', '延平乡', '金峰乡', '达仁乡', '兰屿乡']
        }, {
            name: '花莲县',
            areaList: ['花莲市', '凤林镇', '玉里镇', '新城乡', '吉安乡', '寿丰乡', '光复乡', '丰滨乡', '瑞穗乡', '富里乡', '秀林乡', '万荣乡', '卓溪乡']
        }, {name: '澎湖县', areaList: ['马公市', '湖西乡', '白沙乡', '西屿乡', '望安乡', '七美乡']}, {
            name: '金门县',
            areaList: ['金城镇', '金湖镇', '金沙镇', '金宁乡', '烈屿乡', '乌丘乡']
        }, {name: '连江县', areaList: ['南竿乡', '北竿乡', '莒光乡', '东引乡']}]
    }, {
        name: '香港特别行政区',
        cityList: [{name: '香港岛', areaList: ['中西区', '湾仔区', '东区', '南区']}, {
            name: '九龙',
            areaList: ['油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区']
        }, {name: '新界', areaList: ['荃湾区', '屯门区', '元朗区', '北区', '大埔区', '西贡区', '沙田区', '葵青区', '离岛区']}]
    }, {
        name: '澳门特别行政区',
        cityList: [{name: '澳门半岛', areaList: ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区']}, {
            name: '氹仔岛',
            areaList: ['嘉模堂区']
