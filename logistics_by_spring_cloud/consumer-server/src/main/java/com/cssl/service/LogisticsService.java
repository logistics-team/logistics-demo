...
public interface LogisticsService {
    ...
    @RequestMapping(value = "mailing/save",method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
    public String save(@RequestParam(value = "eg_gmt_create") LocalDateTime eg_gmt_create, @RequestParam(value = "it_id") Integer it_id, @RequestParam(value = "weight") BigDecimal weight,
