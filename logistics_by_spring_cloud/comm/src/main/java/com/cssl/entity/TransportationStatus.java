...
*/
    ...
    //物流状态表
    private LogisticsStatus ls;
    //运输方式
    private TransportMeans tm;

    public LogisticsStatus getLs() {
        return ls;
    }

    public void setLs(LogisticsStatus ls) {
        this.ls = ls;
    }

    public TransportMeans getTm() {
        return tm;
    }

    public void setTm(TransportMeans tm) {
        this.tm = tm;
    }
