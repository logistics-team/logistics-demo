package com.cssl.authentication.shiro;
...
//        String password = userService.getPassword(token.getUsername());
        ...
        String password = userService.getPasswordByPhone(phone);
...
//        System.out.println("password = " + password);
        ...
        return new SimpleAuthenticationInfo(token.getPrincipal(), password, salt, getName());//告诉token加盐处理3
    }
...
//        String role = userMapper.getRole(username);
        String role = userService.getRoleByPhone(principal);
